...
const ALL_PREFS: { id: NotificationPreference; label: string }[] = [
  ...
  { id: 'collective_milestone', label: 'Group milestones' },
      ...
      {tab === 'identity' ? (
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-amber-200 p-5">
            <h3 className="text-xs font-bold uppercase tracking-wider text-amber-800 flex items-center gap-1.5"><Award className="w-3.5 h-3.5" /> Recognition</h3>
            <p className="text-[11px] text-zinc-500 mt-1 leading-relaxed">Earned after completing challenges. Only some achievements are recognised — cheers from friends (Kudos) appear in the feed, not here.</p>
